...
query = ['asset', 'financial', 'economy', 'speculative', 'property', 'economic', 'deflation', 'wage', 'energy', 'gasoline', 'petrol', 'market', 'recession', 'bank', 'infrasture', 'road', 'bridge', 'outage', 'financial', 'fiscal', 'economic', 'fiscal', 'recession', 'unemployment', 'underemployment', 'layoffs', 'inflation', 'weather', 'flood', 'tornado', 'climate']
